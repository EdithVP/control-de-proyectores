...
public class EditarProducto extends AppCompatActivity {
    ...
    public void ConfirmarAlmacen(View v){
       ...
       // Toast.makeText(getBaseContext(),"Almacen creado", Toast.LENGTH_LONG).show();
        ...
        String tipo_pro = tipo.getText().toString();
        String cantidad_pro = cantidad.getText().toString();
        ...
        try {
            ...
            db.execSQL ( "INSERT INTO producto (" +
                    "nombre_almacen,descripcion,tipo_pro,cantidad) VALUES ('" + nombre + "','" + desc +
                    "','" + tipo_pro + "', "+ cantidad_pro +")");
            db.close ();
            Toast.makeText ( this, "Se ingreso correctamente el almacen", Toast.LENGTH_SHORT ).show ();
